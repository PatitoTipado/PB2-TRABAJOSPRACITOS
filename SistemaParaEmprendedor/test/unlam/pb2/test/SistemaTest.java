...
import unlam.pb2.dominio.Empleado;
import unlam.pb2.dominio.EmpleadoPlantaPermanente;
import unlam.pb2.dominio.EmpleadoPlantaTemporaria;
import unlam.pb2.dominio.Gerente;
import unlam.pb2.dominio.Sistema;
...
public class SistemaTest {
	...
	public void gerenteCon160HorasTrabajadasConEsposaUnHijo10AniosDeAntiguedad() {
		...
		Gerente gerente = new Gerente(esCasado, cuit, razonSocial,
				aniosAntiguedad,cantidadHijos);
	...
	public void empresaConCuatroEmpleadosAccedeALosEmpleadosYSueldos() {
		...
		Gerente gerente = new Gerente(esCasado, cuit, razonSocial,
				aniosAntiguedadDiez,cantidadHijos);
		...
		EmpleadoPlantaPermanente empleadoPlantaPermanenteCientoSesentaHoras = new EmpleadoPlantaPermanente(isNoCasado, cuitTres, razonSocialPlantaPermanente,
				aniosAntiguedadCuatro,cantidadHijosCero);

		Integer cantidadHijosDos = 2;
		Integer cantidadDeHorasOchenta = 80;
		Integer cuitDos = 0002;
		Integer aniosAntiguedad=6;

		EmpleadoPlantaPermanente empleadoPlantaPermanenteOchentaHoras = new EmpleadoPlantaPermanente(esCasado, cuitDos, razonSocialPlantaPermanente,
				aniosAntiguedad,cantidadHijosDos);
	
		Integer cuitUno = 0001;
		String razonSocialPlantaTemporaria = "planta temporaria";

		EmpleadoPlantaTemporaria plantaTemporaria = new EmpleadoPlantaTemporaria(esCasado, cuitUno, razonSocialPlantaTemporaria,
				cantidadHijosCero);
