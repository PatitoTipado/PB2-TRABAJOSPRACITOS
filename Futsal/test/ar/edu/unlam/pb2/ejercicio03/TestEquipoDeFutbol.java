...
public class TestEquipoDeFutbol {
	...
	public void queNoSePuedaAgregarUnJugadorSiElEquipoEstaCompleto() {
		// Preparaci�n (Datos de entrada)
		String nombreDelEquipo = "River", nombreJugador1 = "Enzo", nombreJugador2 = "Maidana",
				nombreJugador3 = "Milton", nombreJugador4 = "Barco", nombreJugador5 = "Ponzio",
				nombreJugador6 = "Monteagudo";
		int numeroDelJugador1 = 1, numeroDelJugador2 = 2, numeroDelJugador3 = 3, numeroDelJugador4 = 4,
				numeroDelJugador5 = 5, numeroDelJugador6 = 6, edad = 33;
		double precio = 1000.0;
		boolean resultado = false;
	...
	public void queSeEncuentreUnJugadorPorSuNumero() {
		...
		String nombreDelEquipo = "River", nombreJugador1 = "Enzo", nombreJugador2 = "Maidana",
				nombreJugador3 = "Milton", nombreJugador4 = "Barco", nombreJugador5 = "Ponzio";
		int numeroDelJugador1 = 1, numeroDelJugador2 = 2, numeroDelJugador3 = 3, numeroDelJugador4 = 4,
				numeroDelJugador5 = 5, edad = 33, numeroBuscado = 3;
		double precio = 1000.0;
	...
	public void queNoSeEncuentreUnJugadorSiElNumeroNoEstaEnElEquipo() {
		...
		String nombreDelEquipo = "River", nombreJugador1 = "Enzo", nombreJugador2 = "Maidana",
				nombreJugador3 = "Milton", nombreJugador4 = "Barco", nombreJugador5 = "Ponzio";
		int numeroDelJugador1 = 1, numeroDelJugador2 = 2, numeroDelJugador3 = 3, numeroDelJugador4 = 4,
				numeroDelJugador5 = 5, edad = 33, numeroBuscado = 6;
		double precio = 1000.0;
	...
	public void queSeEncuentreUnJugadorPorSuNombre() {
		...
		String nombreDelEquipo = "River", nombreJugador1 = "Enzo", nombreJugador2 = "Maidana",
				nombreJugador3 = "Milton", nombreJugador4 = "Barco", nombreJugador5 = "Ponzio",
				nombreBuscado = "Milton";
		int numeroDelJugador1 = 1, numeroDelJugador2 = 2, numeroDelJugador3 = 3, numeroDelJugador4 = 4,
				numeroDelJugador5 = 5, edad = 33;
		double precio = 1000.0;
